...
(function(){
    ...
    PicWall.prototype = {
        ...
        init:function(){
            ...
            $.ajax({
                url:_this.debug?"/index/pic_banner.json":"/index/pic_banner_old.json",
                dataType:"json",
        ...
        scroll:function(direction){
            ...
            if(Math.abs(remainder)>0){
                ...
                _this.picScrollWrapper.animate({"left":"-="+stepWidth},1350,'easeOutCirc',function(){
...
function pickBanner(){
    ...
    $.ajax({
        url: 'http://h.bilibili.com/member?mod=addbanner&id=41',
        type: 'get',
        dataType: 'json',
        success : function(data){
            if(!data.item == ''){
